          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('ACCOUNT SETTINGS', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
              ),
              SettingsItems(
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 11),
                child: Text('NOTIFICATIONS', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
              ),
              SettingsItems(
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 11),
                child: Text('APP PREFERENCES', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
              ),
              SettingsItems(
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 11),
                child: Text('HELP & SUPPORT', style: TextStyle(fontSize: 16,fontWeight: FontWeight.w500)),
              ),
              SettingsItems(
